const LOCALES = {
  en: {
    ...
    sourcesDropHint: "Drop video, audio, image or text here",
    ...
    postLangHint: "Language for generated X posts when you ask to write a post.",
    ...
    videoVisualPrefix: "[Visual description]",
    videoAudioPrefix: "[Speech transcript]",
    analyzingVideoVisual: "No speech detected — analyzing video visually…",
    analyzingVideoBoth: "Analyzing audio + video frames in parallel…",
    chatHistory: "Chat history",
    chatHistoryEmpty: "No chats yet",
    chatHistoryNew: "New chat",
    chatHistoryUntitled: "New chat",
    chatHistoryMessages: "{count} messages",
    ...
    settingsBack: "← Back",
    settingsNavExtension: "Extension",
    settingsNavGeneral: "General",
    settingsNavAi: "AI",
    settingsNavAiConnect: "Connection",
    settingsNavContent: "Content",
    settingsPanelGeneralDesc: "Language and transcription for video sources.",
    settingsPanelPostsDesc: "Tone and style for generated posts and chat replies.",
    authTitle: "Sign in to get started",
    authLead: "Create an account or sign in to use posts, chat and X comments.",
    authViewLabel: "How to open",
    ...
    authFillFields: "Fill in email and password",
    authPasswordShort: "Password must be at least 6 characters",
    authProviderNotConfigured: "This sign-in method is not configured yet",
    authEmailTaken: "This email is already registered",
    authInvalidCredentials: "Invalid email or password",
    authViewOpening: "Opening…",
    authViewSideOk: "Side panel opened on the page",
    authViewWindowOk: "Opened in a separate window",
    authViewFullOk: "Opened in a new browser tab",
    authViewFailed: "Could not switch view mode",
    authPopupHint: "Google, Telegram and X open in a separate window so sign-in does not close this panel.",
    authPopupHandoff: "Opening sign-in window…",
    authOAuthSetup: "OAuth setup (Google / Telegram / X)",
    settingsNavAccount: "Account",
    settingsNavProfile: "Profile",
    settingsNavPlans: "Plans",
    settingsPanelPlansDesc: "Shared AI limits and monthly tiers.",
    planUsageTitle: "Your usage today",
    ...
    planProMax: "Pro Max",
    planPerMonth: "/ month",
    planRequestsDay: "{n} AI requests / day",
    planVideosDay: "{n} videos / day",
    planAuthorReplies: "Replies on your posts",
    planAuthorRepliesNo: "No replies on your posts",
    planBuySoon: "Coming soon",
    planBuy: "Subscribe",
    planCheckoutOpening: "Opening payment page…",
    planCheckoutError: "Could not start checkout",
    planPaymentPending: "Complete payment in the new tab. Your plan activates right after.",
    planPaymentSuccess: "Payment confirmed — your plan is active!",
    planExpiresOn: "Plan until {date}",
    planOwnKeyHint:
      "You can always use your own Gemini API key — Settings → Connection → My own API key.",
    planResetsAt: "Resets at midnight UTC",
    settingsPanelProfileDesc: "Your account and sign-in methods.",
    profileSignedInVia: "Signed in via",
    profileProviderEmail: "Email",
    profileProviderGoogle: "Google",
    profileProviderTelegram: "Telegram",
    profileProviderX: "X (Twitter)",
    profileNoEmail: "No email linked",
    profileRecoveryTitle: "Recovery email",
    profileRecoveryDesc: "Link a real email and password to restore access if you lose X or Telegram.",
    profileRecoveryLinked: "Recovery email: {email}",
    profileLinkEmailBtn: "Link email for recovery",
    profileLinkEmailOk: "Recovery email linked",
    profileSignOut: "Sign out",
    profileSignOutConfirm: "Sign out of your account?",
    settingsSectionGeneral: "General",
    settingsSectionPosts: "Posts & chat",
    settingsSectionComments: "Comments on X",
    commentModeEnabled: "cheatX on posts",
    commentModeHint: "Analyze a post and draft a reply — you review and publish on X.",
    authorReplyModeEnabled: "Replies on your posts",
    authorReplyModeHint: "On comments under your posts — cheatX drafts a reply as you.",
    commentLang: "Comment language",
    commentLangAuto: "Auto (match post)",
    commentLangRu: "Russian",
    commentLangPl: "Polish",
    commentLangDe: "German",
    commentLangEs: "Spanish",
    commentLangFr: "French",
    commentMinLen: "Min characters",
    commentMaxLen: "Max characters",
    commentStyle: "Comment style",
    commentStyleSharp: "Sharp & concise",
    commentStyleFriendly: "Friendly",
    commentStyleWitty: "Witty",
    commentStyleExpert: "Expert / insider",
    commentStyleCasual: "Casual",
    commentEmoji: "Emojis in comments",
    commentAnalyzeVideo: "Transcribe video in posts",
    commentAnalyzeImages: "Describe images in posts",
    commentEndWithQuestion: "Sometimes end with a sharp question",
    commentCustomRules: "Extra rules for comments",
    commentCustomRulesPlaceholder:
      "E.g.: no politics, always disagree respectfully, mention data, never use slang…",
  },
  uk: {
    brandTitle: "cheatXtwitter",
    ...
    sourcesDropHint: "Перетягніть сюди відео, аудіо, фото або текст",
    ...
    tempMax: "Максимальна",
    postLang: "Мова постів",
    postLangHint: "Мова згенерованих постів для X, коли просите написати пост.",
    ...
    videoVisualPrefix: "[Візуальний опис]",
    videoAudioPrefix: "[Транскрипт мовлення]",
    analyzingVideoVisual: "Мовлення не знайдено — аналізую відео візуально…",
    analyzingVideoBoth: "Паралельно: аудіо + кадри відео…",
    chatHistory: "Історія чатів",
    chatHistoryEmpty: "Чатів ще немає",
    chatHistoryNew: "Новий чат",
    chatHistoryUntitled: "Новий чат",
    chatHistoryMessages: "{count} повідомлень",
    ...
    settingsPageSubtitle: "Налаштування розширення",
    settingsBack: "← Назад",
    settingsNavExtension: "Розширення",
    settingsNavGeneral: "Загальні",
    settingsNavAi: "ШІ",
    settingsNavAiConnect: "Підключення",
    settingsNavContent: "Контент",
    settingsPanelGeneralDesc: "Мова інтерфейсу та транскрипція відео/аудіо.",
    settingsPanelPostsDesc: "Тон і стиль для постів та відповідей у чаті.",
    authTitle: "Увійдіть, щоб почати",
    authLead: "Створіть акаунт або увійдіть — пости, чат і коментарі на X.",
    authViewLabel: "Як відкривати",
    authGoogle: "Продовжити з Google",
    authTelegram: "Продовжити з Telegram",
    authX: "Продовжити з X",
    authOrEmail: "або email",
    authName: "Ім’я",
    ...
    authSignIn: "Увійти",
    authRegister: "Створити акаунт",
    authNoAccount: "Немає акаунта? Зареєструватися",
    authHaveAccount: "Вже є акаунт? Увійти",
    authFailed: "Не вдалося увійти. Спробуйте ще раз.",
    authCancelled: "Вхід скасовано",
    authFillFields: "Заповніть email і пароль",
    authPasswordShort: "Пароль — мінімум 6 символів",
    authProviderNotConfigured: "Цей спосіб входу ще не налаштований",
    authEmailTaken: "Такий email вже зареєстрований",
    authInvalidCredentials: "Невірний email або пароль",
    authViewOpening: "Відкриваю…",
    authViewSideOk: "Бічну панель відкрито на сторінці",
    authViewWindowOk: "Відкрито в окремому вікні",
    authViewFullOk: "Відкрито у новій вкладці браузера",
    authViewFailed: "Не вдалося перемкнути режим",
    authPopupHint: "Google, Telegram і X відкриваються в окремому вікні — панель не закриється під час входу.",
    authPopupHandoff: "Відкриваю вікно входу…",
    authOAuthSetup: "Налаштування OAuth (Google / Telegram / X)",
    settingsNavAccount: "Акаунт",
    settingsNavProfile: "Профіль",
    settingsNavPlans: "Тарифи",
    settingsPanelPlansDesc: "Ліміти спільного AI та місячні тарифи.",
    planUsageTitle: "Використання сьогодні",
    ...
    planProMax: "Pro Max",
    planPerMonth: "/ міс",
    planRequestsDay: "{n} AI-запитів / день",
    planVideosDay: "{n} відео / день",
    planAuthorReplies: "Відповіді під своїми постами",
    planAuthorRepliesNo: "Без відповідей під своїми постами",
    planBuySoon: "Скоро",
    planBuy: "Оформити",
    planCheckoutOpening: "Відкриваю сторінку оплати…",
    planCheckoutError: "Не вдалося створити рахунок",
    planPaymentPending: "Завершіть оплату у новій вкладці. Тариф активується одразу після оплати.",
    planPaymentSuccess: "Оплату підтверджено — тариф активний!",
    planExpiresOn: "Тариф до {date}",
    planOwnKeyHint:
      "Завжди можна використати свій Gemini API-ключ — Налаштування → Підключення → Мій власний API-ключ.",
    planResetsAt: "Оновлення о 00:00 UTC",
    settingsPanelProfileDesc: "Ваш акаунт і способи входу.",
    profileSignedInVia: "Увійшли через",
    profileProviderEmail: "Email",
    profileProviderGoogle: "Google",
    profileProviderTelegram: "Telegram",
    profileProviderX: "X (Twitter)",
    profileNoEmail: "Email не прив’язано",
    profileRecoveryTitle: "Email для відновлення",
    profileRecoveryDesc: "Прив’яжіть справжній email і пароль — відновите доступ, якщо втратите X або Telegram.",
    profileRecoveryLinked: "Email для відновлення: {email}",
    profileLinkEmailBtn: "Прив’язати email",
    profileLinkEmailOk: "Email для відновлення збережено",
    profileSignOut: "Вийти з акаунта",
    profileSignOutConfirm: "Вийти з акаунта?",
    settingsSectionGeneral: "Загальні",
    settingsSectionPosts: "Пости та чат",
    settingsSectionComments: "Коментарі на X",
    commentModeEnabled: "cheatX на постах",
    commentModeHint: "Аналіз поста і чернетка відповіді — ви перевіряєте й публікуєте на X.",
    authorReplyModeEnabled: "Відповіді на ваші пости",
    authorReplyModeHint: "На коментарях під вашими постами — cheatX чернеткує відповідь від вашого імені.",
    commentLang: "Мова коментаря",
    commentLangAuto: "Авто (як у пості)",
    commentLangRu: "Російська",
    commentLangPl: "Польська",
    commentLangDe: "Німецька",
    commentLangEs: "Іспанська",
    commentLangFr: "Французька",
    commentMinLen: "Мін. символів",
    commentMaxLen: "Макс. символів",
    commentStyle: "Стиль коментаря",
    commentStyleSharp: "Гострий і стислий",
    commentStyleFriendly: "Дружній",
    commentStyleWitty: "Дотепний",
    commentStyleExpert: "Експертний",
    commentStyleCasual: "Розмовний",
    commentEmoji: "Емодзі в коментарях",
    commentAnalyzeVideo: "Транскрибувати відео в постах",
    commentAnalyzeImages: "Описувати зображення в постах",
    commentEndWithQuestion: "Іноді закінчувати гострим питанням",
    commentCustomRules: "Додаткові правила для коментарів",
    commentCustomRulesPlaceholder:
      "Напр.: без політики, завжди поважно не погоджуватись, згадувати цифри, без сленгу…",
  },
};
...
function applyPageI18n() {
  document.querySelectorAll("[data-i18n]").forEach((el) => {
    if (el.id === "aiModeHint" || el.id === "settingsVersion" || el.id === "windowVersion" || el.id === "appSettingsVersion") return;
